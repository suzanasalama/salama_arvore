...
% \addcontentsline{toc}{chapter}{\textsc{bava} {\frank א}\quad XXXXXXXXX}
% \chapter*{Bava \frank{ב}}
% \addcontentsline{toc}{chapter}{\textsc{bava} {\frank ב}\quad XXXXXXXXX}
% \chapter*{Bava \frank{ג}}
% \addcontentsline{toc}{chapter}{\textsc{bava} {\frank ג}\quad XXXXXXXXX}
% \chapter*{Bava \frank{ד}}
% \addcontentsline{toc}{chapter}{\textsc{bava} {\frank ד}\quad XXXXXXXXX}
% \chapter*{Bava \frank{ה}}
% \addcontentsline{toc}{chapter}{\textsc{bava} {\frank ה}\quad XXXXXXXXX}
% \chapter*{Bava \frank{ו}}
% \addcontentsline{toc}{chapter}{\textsc{bava} {\frank ו}\quad XXXXXXXXX}
% \chapter*{Bava \frank{ז}}
% \addcontentsline{toc}{chapter}{\textsc{bava} {\frank ז}\quad XXXXXXXXX}
% \chapter*{Bava \frank{ח}}
% \addcontentsline{toc}{chapter}{\textsc{bava} {\frank ח}\quad XXXXXXXXX}
