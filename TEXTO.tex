...
Ao atravessar um limite, percebemos quão claros se tornam os contextos externos e internos. Pois o limite anuncia um ponto de observação que, por sua vez, exige muito mais das noções prévias acumuladas pelo forasteiro do que da experiência em si. É a bagagem, o que se aprendeu ao longo da vida, a tradição, a memória. O passado. Mesmo o limite sendo um portão que leva ao espaço desconhecido, é a partir da reprodução ou formatação dessas noções prévias que torna-se possível adentrar e compreender esse novo lugar. Como bússola e escudo, o único arcabouço possível na jornada



, sendo o único  de consulta possível. O real é também o passado.

as noções de {\formularlightitalic{olam}}, «mundo», {\formularlightitalic{shaná}}, «tempo» e {\formularlightitalic{nefesh}}, «homem», 


— e, inclusive, justamente por isso. 
...
\paragraph{As 10 \textit{sefirót}} são emanações divinas que estruturam o espaço, o tempo e o ser. Elas permitem ao \textit{ein sof}, o ``ilimitado'', se tornar mundo. Estão relacionadas aos números de 1 a 10. % \textit{blimá} ou ``vindas do vazio''

\paragraph{As 22 as letras} do alfabeto hebraico são instrumentos de criação: forças arquetípicas que estruturam tudo o que existe.
