...
É quando atravessemos um limite que percebemos quão claros se tornam os contextos, externos e internos. Pois um limite anuncia um ponto de observação. E, por conta disso, 


Ao atravessar um limite, os contextos ficam mais claros do que nunca. Isso porque ele anuncia um ponto de observação que, por conta disso, ativa necessariamente noções que adquirimos ao longo do tempo: ou seja, no passado. Mesmo que esse limite apresente um espaço desconhecido, 


O conhecimento e as impressões prévias servem como bússola e escudo, sendo o único arcabouço de consulta possível. O real é também o passado.
